...
namespace SonoBooking.Api.Controllers.V1.Housing
{
    ...
    [Authorize]
    public class UnitImagesController(IUnitImageService unitImageService) : BaseController
    {
        [HttpGet("get/{id}")]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status200OK)]
        public async Task<ActionResult<IFinalResult>> GetAsync(string id, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await unitImageService.GetByIdAsync(id, cancellationToken);
            return Ok(res);
        }
        ...
        {
            IFinalResult res = await unitImageService.GetAllAsync(cancellationToken: cancellationToken);
            return Ok(res);
        }

        [HttpPost("getPaged")]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status200OK)]
        public async Task<ActionResult<PagingResult>> GetPagedAsync([FromBody] BaseParam<UnitImageFilter> filter, CancellationToken cancellationToken = default)
        {
            PagingResult res = await unitImageService.GetAllPagedAsync(filter, cancellationToken);
            return Ok(res);
        }
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddUnitImageDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await unitImageService.AddAsync(dto, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddUnitImageDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await unitImageService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await unitImageService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await unitImageService.DeleteSoftAsync(id, cancellationToken);
